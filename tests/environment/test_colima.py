"""
Tests for Colima setup (graduated from Story-32).

These tests verify Colima is installed and the VM can be started/accessed.
...
class TestColimaInstallation:
    """Tests for Colima installation (FR1)."""
...
class TestColimaVMStatus:
    """Tests for VM status and accessibility (FR2, FR3)."""
